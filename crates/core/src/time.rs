//! Tick-based time model: the granularity of game time and quest progress.
//!
//! Time is modelled as discrete **ticks** here; wall-clock pacing and rendering
//! live in the front-ends. [`Progress`] is pure — it never touches the clock or
//! the terminal — so the same model drives the real-time TUI and headless tool
//! simulations identically.
